...
/*=============================================
ADMINISTRACIÓN DE CARPETAS RUTAS Y ARCHIVOS EN NODEJS
=============================================*/
...
let crearSlide = (req, res) => {
    ...
    //Capturar la extensión del archivo, split separa uina cadena de texto en un array  pop toma el ultimo valor 
            ...
            return new Promise((resolve, reject) => {
                ...
                if (req.files) {
                    ...
                    archivo.mv(`./archivos/slide/${nombre}.${extension}`, err => {
                        ...
                        //Borramos la antigua imagen si existe 
...
/*=============================================
FUNCION PARA MOSTRAR IMAGENES GET
=============================================*/
